...
import { fontSizeTheme, FONT_SANS, FONT_MONO } from './tailwind/airtable/type-scale.mjs'
...
export default {
  ...
  theme: {
    extend: {
      ...
      // Airtable type ramp. `text-<size>` and `text-p-<size>` are utilities
      ...
      // components and are re-declared in src/styles/airtable-typography.css
      // instead; both read the same numbers from tailwind/airtable/type-scale.mjs.
